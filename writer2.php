...
echo "<tr height='25' class='headline'><td>Name</td><td>Vorname</td><td>Mail</td><td>PLZ</td><td>Ort</td><td>Update</td><td>L&ouml;schen?</td></tr>";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td class='image'><a href='06_updateform.php?id=$id'><img src='b_edit.png'></a></td>";
    echo "<td class='image'><a href='05_delete_confirm.php?id=$id'><img src='b_drop.png'></td></tr>";
    $i++;
}
